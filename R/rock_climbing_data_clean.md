Rock climbing survey data claning
================
Sunny Tseng
2023-03-05
...
```
    ...
    ##  $ I love to climb                                                                                    : chr [1:25] "Agree" "Agree" "Disagree" "Agree" ...
    ##  $ Climbing is fun                                                                                    : chr [1:25] "Agree" "Agree" "Agree" "Agree" ...
    ##  $ I am motivated to climb                                                                            : chr [1:25] "Agree" "Agree" "Agree" "Agree" ...
    ##  $ I feel encouraged in my climbing                                                                   : chr [1:25] "Agree" "Agree" "Disagree" "Agree" ...
    ##  $ I feel hindered in my climbing                                                                     : chr [1:25] "Strongly Disagree" "Disagree" "Agree" "Disagree" ...
    ##  $ I am inspired to climb by my female-identified climbing friends                                    : chr [1:25] "Strongly Agree" "Agree" "Strongly Agree" "Strongly Agree" ...
    ##  $ I am inspired to climb by films showcasing outdoor women climbers                                  : chr [1:25] "Agree" "Agree" "Agree" "Strongly Agree" ...
    ##  $ I am inspired to spend more time outdoors after watching films that showcase outdoor women climbers: chr [1:25] "Agree" "Agree" "Agree" "Strongly Agree" ...
    ##  $ I feel represented within the climbing community                                                   : chr [1:25] "Agree" "Agree" "Disagree" "Strongly Disagree" ...
    ##  $ I feel outdoor climbing guides are representative of the larger Vancouver and Squamish area        : chr [1:25] "Agree" "Disagree" NA "Strongly Disagree" ...
    ##  $ I feel welcomed in the climbing community                                                          : chr [1:25] "Agree" "Agree" "Agree" "Agree" ...
    ##  $ I feel safe in the climbing community                                                              : chr [1:25] "Agree" "Agree" "Disagree" "Agree" ...
    ##  $ I feel connected to the climbing community                                                         : chr [1:25] "Agree" "Agree" "Disagree" "Disagree" ...
    ##  $ I feel the climbing community reflects the diversity of Vancouver and Squamish areas               : chr [1:25] "Agree" "Agree" "Disagree" "Strongly Disagree" ...
    ##  $ I feel it is possible for anyone to progress in climbing                                           : chr [1:25] "Agree" "Agree" "Disagree" "Strongly Disagree" ...
    ##  $ I find indoor climbing more accessible than outdoor climbing                                       : chr [1:25] "Agree" "Agree" "Strongly agree" "Strongly Disagree" ...
    ##  $ I find it difficult to find the resources to go outdoor climbing                                   : chr [1:25] "Agree" "Agree" "Agree" "Strongly Agree" ...
    ##  $ I find it difficult to find the time to go outdoor climbing                                        : chr [1:25] "Agree" "Disagree" "Disagree" "Disagree" ...
    ##  $ I find it difficult to find transportation to outdoor climbing                                     : chr [1:25] "Agree" "Disagree" "Strongly Agree" "Strongly Agree" ...
    ##  $ I find it difficult to find friends to go outdoor climbing with                                    : chr [1:25] "Agree" "Agree" "Agree" "Strongly Agree" ...
...
```
    ...
    ##  $ I love to climb                                                                                    : chr [1:24] "Strongly Agree" "Disagree" "Strongly Agree" "Agree" ...
    ##  $ Climbing is fun                                                                                    : chr [1:24] "Strongly Agree" "Agree" "Strongly Agree" "Agree" ...
    ##  $ I am motivated to climb                                                                            : chr [1:24] "Strongly Agree" "Agree" "Strongly Agree" "Agree" ...
    ##  $ I feel encouraged in my climbing                                                                   : chr [1:24] "Strongly Agree" "Agree" "Strongly Agree" "Strongly Agree" ...
    ##  $ I feel hindered in my climbing                                                                     : chr [1:24] "Disagree" "Agree" "Disagree" "Disagree" ...
    ##  $ I am inspired to climb by my female-identified climbing friends                                    : chr [1:24] "Strongly Agree" "Strongly Agree" "Strongly Agree" "Strongly Agree" ...
    ##  $ I am inspired to climb by films showcasing outdoor women climbers                                  : chr [1:24] "Agree" "Strongly Agree" "Agree" "Agree" ...
    ##  $ I am inspired to spend more time outdoors after watching films that showcase outdoor women climbers: chr [1:24] "Agree" "Agree" "Strongly Agree" "Agree" ...
    ##  $ I feel represented within the climbing community                                                   : chr [1:24] "Disagree" "Agree" "Disagree" "Disagree" ...
    ##  $ I feel outdoor climbing guides are representative of the larger Vancouver and Squamish area        : chr [1:24] "Disagree" "Disagree" "Disagree" "Disagree" ...
    ##  $ I feel welcomed in the climbing community                                                          : chr [1:24] "Agree" "Agree" "Strongly agree" "Agree" ...
    ##  $ I feel safe in the climbing community                                                              : chr [1:24] "Agree" "Agree" "Strongly agree" "Agree" ...
    ##  $ I feel connected to the climbing community                                                         : chr [1:24] "Disagree" "Disagree" "Strongly agree" "Disagree" ...
    ##  $ I feel the climbing community reflects the diversity of Vancouver and Squamish areas               : chr [1:24] "Strongly Disagree" "Disagree" "Disagree" "Disagree" ...
    ##  $ I feel it is possible for anyone to progress in climbing                                           : chr [1:24] "Strongly agree" "Strongly agree" "Strongly agree" "Agree" ...
    ##  $ I find indoor climbing more accessible than outdoor climbing                                       : chr [1:24] "Agree" "Strongly agree" "Strongly agree" "Strongly agree" ...
    ##  $ I find it difficult to find the resources to go outdoor climbing                                   : chr [1:24] "Strongly Agree" "Agree" "Strongly Agree" "Disagree" ...
    ##  $ I find it difficult to find the time to go outdoor climbing                                        : chr [1:24] "Agree" "Disagree" "Strongly Agree" "Agree" ...
    ##  $ I find it difficult to find transportation to outdoor climbing                                     : chr [1:24] "Strongly Agree" "Disagree" "Strongly Agree" "Agree" ...
    ##  $ I find it difficult to find friends to go outdoor climbing with                                    : chr [1:24] "Agree" "Disagree" "Strongly Agree" "Agree" ...
